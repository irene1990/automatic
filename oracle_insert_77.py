...
#conn = cx_Oracle.connect("system/dingjia@192.168.88.253:1521/ORCL")
#c = conn.cursor()
#print 'you have already in oracle'
#time.sleep(10800)
#tablespace = ['custom_detail"','"goods_detail"','"supplier_detail']
#i = 30000
#s = 40000
...
#r = Random_Char(1)
#sql1 = "create table one_1(id number(20),a varchar2(200)) tablespace one"
#sql2 = 'insert into one_1 values('+str(i)+",'"+str(time.strftime('%a %b %d %H:%M:%S %Y',time.localtime(time.time())))+"')"
#print sql2
#c.execute(sql2)
#conn.commit()
#add tables
...
conn = cx_Oracle.connect("system/Scutech123@192.168.82.185:1521/RAC.localdomain")
c = conn.cursor()
#r = Random_Char(1)
#print 'you have already in oracle'
#f = open("insert2.log", 'a')
#k=11234
#ak = k+30000
...
mk=8000
while k < mk:
    sql1 = "insert into kk values('after',sysdate)"
    print sql1
    c.execute(sql1)
    conn.commit()
    k += 1
