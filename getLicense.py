...
def getLicense(applyCode):
    ...
    loginPostData = urllib.urlencode({"username":"wangsx","password":"wangsx123"})
    ...
    licensePostData = OrderedDict((("contract","Tester01"),("customer","testing"),("note","testing"),("type","dbackup4"),("state",1),
    ...
    licensePostData["properties"] = [OrderedDict((("name","clientnum"),("value",10))),
        ...
        OrderedDict((("name","authosdb"),("value",9),("pre_value","2O"))),
        OrderedDict((("name","authosdb"),("value",9),("pre_value","3O"))),
        OrderedDict((("name","authosdb"),("value",9),("pre_value","4O"))),
        OrderedDict((("name","authosdb"),("value",9),("pre_value","5O"))),
        OrderedDict((("name","authosdb"),("value",9),("pre_value","1S"))),
        OrderedDict((("name","authosdb"),("value",9),("pre_value","1M"))),
        OrderedDict((("name","authosdb"),("value",9),("pre_value","2M"))),
        OrderedDict((("name","authosdb"),("value",9),("pre_value","1A"))),
        OrderedDict((("name","authosdb"),("value",9),("pre_value","2A"))),
        OrderedDict((("name","authosdb"),("value",9),("pre_value","3A"))),
        OrderedDict((("name","authosdb"),("value",9),("pre_value","4A"))),
        OrderedDict((("name","authosdb"),("value",9),("pre_value","5A"))),
